...
static const u16 sNaturePowerMoves[] =
{
    ...
    [BATTLE_TERRAIN_GRAY_CAVE] = MOVE_HYDRO_PUMP,
...
static const u8 sTerrainToType[] =
{
    ...
    [BATTLE_TERRAIN_GRAY_CAVE] = TYPE_WATER,
            ...
            case MOVE_EFFECT_STEAL_ITEM:
                {
                        ...
                        && gBattleMons[gBattlerTarget].ability == ABILITY_STICKY_HOLD)
                    {
                        ...
                        || gBattleMons[gBattlerTarget].item == ITEM_072
                        || gBattleMons[gBattlerTarget].item == ITEM_073
                        || gBattleMons[gBattlerTarget].item == ITEM_074
                        || gBattleMons[gBattlerTarget].item == ITEM_075
                        || gBattleMons[gBattlerTarget].item == ITEM_076)
                    {
                        gBattlescriptCurrInstr++;
                    }
                    else
...
static void Cmd_hiddenpowercalc(void)
{
    ...
    // The final + 1 skips past Normal, and allows getting to TYPE_DARK.
    // If the number equals TYPE_MISTERY, the typing changes to TYPE_FAIRY.
