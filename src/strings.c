...
const u8 gText_OpenLevel[] = _("HARD");
...
const u8 gText_1000CoinsAndPrice[] = _("1,000 COINS{CLEAR_TO 0x48}¥20,000");
const u8 gText_2500CoinsAndPrice[] = _("2,500 COINS{CLEAR_TO 0x48}¥50,000");
const u8 gText_5000CoinsAndPrice[] = _("5,000 COINS{CLEAR_TO 0x48}¥100,000");
